...
<body>
    ...
    <!-- Hero Section -->
    <div class="hero-section" style="background-image: url('https://images.unsplash.com/photo-1495474472287-4d71bcdd2085');">
    <div class="hero-overlay"></div>
    <div class="hero-content container text-center">
        <h1 class="hero-title">Cafeteria</h1>
        <p class="hero-subtitle">Enjoy a cozy experience with the best coffee and snacks in a warm atmosphere.</p>
        <button class="btn btn-primary btn-lg" onclick="scrollToProducts()">Order Now</button>
    </div>
</div>
